...
sed -i -e "/MONGO_DNSNAME/localhost/" /home/roboshop/catalogue/systemd.service $>>$LOG && mv /home/roboshop/catalogue/systemd.service /etc/systemd/system/catalogue.service
STAT_CHECK $?
